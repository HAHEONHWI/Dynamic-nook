...
[![DMG 다운로드](https://img.shields.io/badge/DMG_다운로드-1.0_Beta-0A84FF?style=for-the-badge&logo=apple&logoColor=white)](https://github.com/HAHEONHWI/Dynamic-nook/releases/download/v1.0.0-beta/Dynamic-Nook-1.0-Beta.dmg)
...
1. [Dynamic Nook 1.0 Beta DMG 다운로드](https://github.com/HAHEONHWI/Dynamic-nook/releases/download/v1.0.0-beta/Dynamic-Nook-1.0-Beta.dmg)를 누릅니다.
...
산출물: `dist/Dynamic-Nook-1.0-Beta.dmg`
...
Dynamic Nook **1.0 Beta**입니다. 핵심 기능은 동작하지만 Private Framework, DDC/CI 디스플레이, 하드웨어별 덮개 잠자기 방지, 미인증 배포 동작은 Mac과 macOS 버전에 따라 달라질 수 있습니다.
