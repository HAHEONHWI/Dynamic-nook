...
![Release](https://img.shields.io/badge/release-1.0%20Beta-168BFF)

[![Download DMG](https://img.shields.io/badge/Download_DMG-1.0_Beta-0A84FF?style=for-the-badge&logo=apple&logoColor=white)](https://github.com/HAHEONHWI/Dynamic-nook/releases/download/v1.0.0-beta/Dynamic-Nook-1.0-Beta.dmg)

</div>

> [!NOTE]
> Dynamic Nook is currently a beta release for direct distribution, not a Mac App Store application. It is source-available for noncommercial use only.
...
| Reminders with quick add | Audio output and volume | NEIS meals and school schedule |
...
1. Download [Dynamic Nook 1.0 Beta DMG](https://github.com/HAHEONHWI/Dynamic-nook/releases/download/v1.0.0-beta/Dynamic-Nook-1.0-Beta.dmg).
...
Output: `dist/Dynamic-Nook-1.0-Beta.dmg`
...
Dynamic Nook **1.0 Beta**. Core features work, but private-framework behavior, DDC/CI display support, hardware-specific sleep prevention, and unsigned distribution can vary by Mac and macOS version.
